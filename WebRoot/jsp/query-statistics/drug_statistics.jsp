...
<div id="sidebar">
	...
	<ul>
		...
		<li class="submenu active open"><a href="#"><i class="icon icon-file"></i>
			...
			<ul>
				<li class="active"><a href="show_drug">药品信息统计</a></li>
...
<!-- 										<th>操作</th> -->
							...
							<tbody>
									<c:forEach items="${drugInformationsList}" var="drugInformations" varStatus="varInt">
										<tr>
										<td><input type="checkbox" /></td>
											<th>${varInt.count}</th>
											<td>${drugInformations.drugNumber}</td>
											<td>${drugInformations.drugName}</td>
											<td>${drugInformations.drugSpecifications}</td>
											<td>${drugInformations.drugUnit}</td>
											<td>${drugInformations.drugFee}</td>
										</tr>
									</c:forEach>
							</tbody>
						</table>
...
<!--
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="search_drug" method="post">
				<div class="modal-body set-hight">
					<div>
						<div class="add-information">药品编号：</div>
						<input id="number" type="text" pattern="^[\d]{0,20}$"
					...
					<div>
						...
						<input id="specifications" type="text" maxLength="20"
...
// 	window.location.href="show_drug";
	return true;
}
