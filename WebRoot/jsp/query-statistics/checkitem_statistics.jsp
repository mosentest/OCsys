...
<link rel="stylesheet" type="text/css" href="css/information-input.css" />
...
-->
			...
			<li class="submenu active open"><a href="#"><i class="icon icon-file"></i>
					<span>查询统计</span> <span class="label label-important">5</span></a>
				<ul>
					<li><a href="show_drug">药品信息统计</a></li>
					<li class="active"><a href="show_checkitem">检查项信息统计</a></li>
		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="index.jsp" title="返回主页" class="tip-bottom"><i
					class="icon-home"></i> 主页</a> <a href="#" class="tip-bottom">统计查询</a>
				<a href="#" class="current">检查项信息统计</a>
			</div>
...
<!-- 										<th>操作</th> -->
								...
								<tbody>
								<c:forEach items="${checkitemInformationList}" var="checkitemInformation" varStatus="varInt">
									<tr>
									<td><input type="checkbox" /></td>
											<th>${varInt.count}</th>
											<td>${checkitemInformation.checkitemNumber}</td>
											<td>${checkitemInformation.checkitemName}</td>
											<td>${checkitemInformation.checkitemUnit}</td>
											<td>${checkitemInformation.checkitemFee}</td>
									</tr>
									</c:forEach>
								</tbody>
							</table>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="search_checkItem" method="post">
					<div class="modal-body set-hight">
						...
						<div>
							...
							<input type="text" pattern="[\d]{0,20}$" title="编号最长为20位阿拉伯数字"
...
<!-- 							<input type="number" min="0.00" max="99999999.99" 	step="0.01" -->
