...
<title>My JSP 'operator_information.html.jsp' starting page</title>
...
<body>
	...
	<!--sidebar-menu-->
	<div id="sidebar">
		<a href="#" class="visible-phone"><i class="icon icon-tint"></i>Buttons
			&amp; icons</a>
		<ul>
			<li><a href="index.html"><i class="icon icon-home"></i> <span>欢迎使用本系统</span></a>
			</li>
			<!--
                	作者：515898710@QQ.COM
                	时间：2014-12-30
			...
			<li class="submenu"><a href="#"><i class="icon icon-list"></i>
					<span>划价收费管理</span> <span class="label label-important">3</span></a>
				<ul>
					<li><a href="show_registration_information">诊疗结算</a></li>
					<li><a href="medical-refund.html">诊疗退费</a></li>
					<li><a href="settle-account.html">收费日结</a></li>
				</ul></li>
			...
			<li class="active"><a href="operator-information.html"><i
					class="icon icon-tint"></i> <span>操作员信息管理</span></a></li>
		</ul>
	</div>
		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="#" title="Go to Home" class="tip-bottom"><i
					class="icon-home"></i> 主页</a> <a href="#" class="current">操作员信息管理</a>
			</div>
			<!--
                	作者：515898710@qq.com
                	时间：2014-12-31
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<button class="btn btn-primary">添加操作员</button>
				</div>
			</div>
								...
								<table
									...
									<tbody>
										<tr>
											...
											<td>20141231160544</td>
											<td>ABC君</td>
											<td>男</td>
											<td>23</td>
											<td>20141231161402</td>
										</tr>
										<tr>
											<td><input type="checkbox" /></td>
											<td>20141231160632</td>
											<td>RH君</td>
											<td>男</td>
											<td>43</td>
											<td>20141231161421</td>
										</tr>
										<tr>
											<td><input type="checkbox" /></td>
											<td>20141231160707</td>
											<td>KK君</td>
											<td>男</td>
											<td>35</td>
											<td>20141231161432</td>
										</tr>
										<tr>
											<td><input type="checkbox" /></td>
											<td>20141231160737</td>
											<td>TT君</td>
											<td>男</td>
											<td>54</td>
											<td>20141231161449</td>
										</tr>
										<tr>
											<td><input type="checkbox" /></td>
											<td>20141231160805</td>
											<td>ZZ君</td>
											<td>男</td>
											<td>53</td>
											<td>20141231161504</td>
										</tr>
										<tr>
											<td><input type="checkbox" /></td>
											<td>20141231160838</td>
											<td>NH君</td>
											<td>男</td>
											<td>58</td>
											<td>20141231161515</td>
										</tr>
									</tbody>
								</table>
							</div>
