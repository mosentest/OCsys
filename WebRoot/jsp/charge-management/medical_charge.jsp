					...
					<div class="widget-box">
						...
						<div class="widget-content">
							<table
								...
								<tbody>
									<%
// 										ArrayList<TbManageRegistration> list = (ArrayList<TbManageRegistration>) session
// 												.getAttribute("manageRegistrationList");
// 										if (!list.isEmpty()) {
// 											for (int i = 0; i < list.size(); i++) {
// 												TbManageRegistration registration = (TbManageRegistration) list
// 														.get(i);
									%>
									<c:forEach items="${manageRegistrationList}" var="registration" varStatus="varInt">
										<tr>
											...
											<td><fmt:formatDate value="${registration.registerTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
											<td>${registration.settlementMethod}</td>
											<td><span class="badge badge-warning">诊疗中</span></td>
											<td class="taskOptions"><a href="browse_registration_information?manageRegistration.registrationNumber=${registration.registrationNumber}&type=1" class="tip-top"
												data-original-title="查看详情"><i class="icon-zoom-in"
												style="color: #3A87AD;"></i>
										</a> <a
												href="medical_charge?manageRegistration.registrationNumber=${registration.registrationNumber}&type=2"
												class="tip-top" data-original-title="办理结算"><i
												class="icon-money" style="color: #468847"></i></a></td>
										</tr>
									</c:forEach>
									<%
// 										}
