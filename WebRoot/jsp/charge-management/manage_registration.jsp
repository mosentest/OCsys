...
<title>My JSP 'registration_manage.jsp' starting page</title>
...
<div id="sidebar">
	...
	<ul>
		...
		<li class="submenu active open"><a href="#"><i
			...
			<ul>
				<li class="active"><a
					href="jsp/charge-management/manage_registration.jsp">办理挂号</a></li>
					...
					<div class="row-fluid">
						...
						<div class="span6">
							...
							<div class="widget-box">
								...
								<form class="form-horizontal" action="manage_regist"
									onsubmit="return showMessage()" method="post">
									...
									<div class="widget-content nopadding">
										<s:token>
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" class="span8" placeholder="请输入病人姓名"
														pattern="^[\u4e00-\u9fa5 a-zA-Z]{2,20}$"
														title="请输入中文或英文名称。" required="required"
														name="manageRegistration.patientName" id="patientName" />
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<label style="float: left;"> <input type="radio"
														checked="true" value="男"
														name="manageRegistration.patientSex" />男
													</label><label style="float: left;"> <input type="radio"
														value="女" name="manageRegistration.patientSex" /> 女
													</label>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<input type="number" min="0" max="150" value="0"
														class="span8" placeholder="请输入病人年龄"
														pattern="[\u4e00-\u9fa5]{2,20}$" required="required"
														name="manageRegistration.patientAge" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">患者类型：</label>
												<div class="controls">
													<input type="text" class="span8" placeholder="请输入病人类型"
														pattern="[\u4e00-\u9fa5]{2,20}$" required="required"
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" class="span8" placeholder="请输入结算方式"
														pattern="[\u4e00-\u9fa5]{2,20}$" required="required"
										...
										<div class="form-actions" style="padding-right: 20%">
...
<script type="text/javascript">
	function showMessage() {
		...
		name=name.replace(/^[/s ]*/,"");
		name=name.replace(/[/s ]*$/,"");
		$("#patientName").attr("value",name);
		if(name.length<1){
			alert("请填写患者的名字。");
			return false;
		}else{
			alert("成功为患者 " + name + " 办理挂号业务！");
			return true;
		}
	}
</script>
